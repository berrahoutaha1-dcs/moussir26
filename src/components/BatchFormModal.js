...
export default function BatchFormModal({
  ...
  // Mock products list (normally this would come from a context or API)
  const products = [
    { id: '1', designation: 'Crème hydratante visage', currentQuantity: 534 },
    { id: '2', designation: 'Luvim', currentQuantity: 198 },
    { id: '3', designation: 'maskas test 01', currentQuantity: 0 },
    { id: '4', designation: 'maskas test 02', currentQuantity: 15 },
    { id: '5', designation: 'maskas test 03', currentQuantity: 42 },
    { id: '6', designation: 'maskas test 04 sans internet', currentQuantity: 8 },
    { id: '7', designation: 'maskas test 05 sans internet', currentQuantity: 120 },
    { id: '8', designation: 'PRES TUBE', currentQuantity: 699 }
  ];
