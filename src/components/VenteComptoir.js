          ...
          <div className="flex-1 bg-white">
            ...
            <div className="flex-1 overflow-y-auto">
              {products.map((product, index) => (
                <div 
                  key={product.id} 
                  className={`grid grid-cols-4 border-b border-gray-200 text-sm min-h-[52px] cursor-pointer hover:bg-blue-50 ${
                    selectedProductIndex === index ? 'bg-blue-100 border-l-4 border-l-blue-500' : ''
                  }`}
